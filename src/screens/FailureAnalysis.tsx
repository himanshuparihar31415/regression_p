...
const MOCK_FAILURES = [
  ...
  { id: 'TC_127', name: 'API Rate Limit', class: 'Code Bug', conf: '87%', status: 'AI Classified', error: 'AssertionError: expected HTTP 429 but received HTTP 200 — rate limit not enforced', stack: 'at Object.test (tests/api_gateway.spec.ts:31:12)\nat runTest (node_modules/jest/build/run.js:88:7)', aiAnalysis: 'The rate limiting middleware appears to have been bypassed due to a misconfigured API route prefix in the latest deploy. Rate counter is not incrementing correctly for this endpoint.' },
  { id: 'TC_148', name: 'Report Export PDF', class: 'Environment', conf: '95%', status: 'AI Classified', error: 'Error: PDF generation timeout — report service returned 504 Gateway Timeout', stack: 'at ReportService.export (src/services/report.ts:77:11)\nat Object.test (tests/reporting.spec.ts:24:18)', aiAnalysis: 'The reporting microservice on Pre-Prod is under-resourced and timing out under load. No code changes required — environment scaling recommended.' },
  { id: 'TC_156', name: 'Session Token Expiry', class: 'Data Issue', conf: '79%', status: 'Unclassified', error: 'Error: JWT expired — token exp claim in the past (exp: 1700000000)', stack: 'at AuthMiddleware.verify (src/middleware/auth.ts:33:9)\nat Object.test (tests/session.spec.ts:15:6)', aiAnalysis: 'The test is using a pre-signed JWT token that has already expired. Regenerate tokens in the test data setup phase.' },
  { id: 'TC_163', name: 'Dashboard Load Time', class: 'Environment', conf: '91%', status: 'AI Classified', error: 'Error: Performance assertion failed — page load took 8420ms, expected < 3000ms', stack: 'at Page.goto (node_modules/playwright/lib/page.js:210:15)\nat Object.test (tests/dashboard.spec.ts:9:5)', aiAnalysis: 'Dashboard load degradation linked to UAT_CLUSTER_01 slow disk I/O during peak test window. Recommend scheduling execution outside peak hours.' },
];
