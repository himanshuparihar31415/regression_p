      ...
      <aside className="w-64 bg-surface-container-low border-r border-outline-variant/10 flex flex-col shrink-0">
        <div className="p-4 border-b border-outline-variant/10">
          <div className="relative">
            ...
            <input className="w-full bg-surface-container-high border-none rounded-md pl-9 pr-3 py-1.5 text-[11px] focus:ring-1 focus:ring-primary" placeholder="Search scripts..." type="text"/>
          </div>
        </div>
        <div className="flex-1 overflow-y-auto p-2 space-y-1 no-scrollbar">
          ...
          <div className="space-y-0.5">
            ...
            <div className="ml-4 space-y-0.5">
              ...
              <div className="ml-4 space-y-0.5">
                <div className="flex items-center gap-2 px-2 py-1.5 rounded bg-primary/5 text-primary font-bold border-l-2 border-primary">
                  <FileCode className="w-4 h-4" />
                  <span className="text-xs">payment_flow.spec.ts</span>
                </div>
                <div className="flex items-center gap-2 px-2 py-1.5 rounded hover:bg-surface-container-high cursor-pointer">
                  <FileCode className="w-4 h-4 text-outline" />
                  <span className="text-xs">auth_gate.spec.ts</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="flex-1 flex flex-col min-w-0 bg-surface-container-lowest">
        <div className="px-6 py-3 border-b border-outline-variant/10 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-bold text-on-surface">payment_flow.spec.ts</span>
          </div>
          <div className="flex gap-2">
            <button className="p-1.5 hover:bg-surface-container-high rounded transition-colors">
              <Clock className="w-4 h-4 text-outline" />
            </button>
            <button className="bg-primary text-on-primary px-3 py-1 rounded text-[10px] font-bold uppercase tracking-widest flex items-center gap-1.5 shadow-sm">
