...
import { Play, TrendingUp, Search, Database, Github, GitBranch, RefreshCw, CheckCircle2, AlertCircle, Layers } from 'lucide-react';
            ...
            <div className="bg-surface-container-lowest rounded-md ring-1 ring-outline-variant/15 overflow-hidden">
              ...
              <div className="grid grid-cols-4 gap-0 divide-x divide-y divide-outline-variant/10">
                {MOCK_IMPACTED_MODULES.map((mod) => (
                  <div key={mod.name} className="p-4 hover:bg-surface-container-high transition-colors group">
                    ...
                    <div className="flex items-center justify-between mb-1">
                      <span className={`text-[10px] font-black uppercase px-1.5 py-0.5 rounded-sm ${
                        mod.impact === 'High' ? 'bg-error/10 text-error' :
                        mod.impact === 'Medium' ? 'bg-primary/10 text-primary' :
